...
GUI-обёртка для **Zapret 2** (winws2 / lua-desync) — обход DPI-блокировок на Windows без VPN.

Одна универсальная стратегия, встроенный тестер, диагностика и установка службой.

> ⚠️ **Дисклеймер.** Инструмент предназначен для обхода технических ограничений (DPI) в личных целях. Используя программу, вы берёте ответственность за соблюдение законов своей страны на себя.
...
- [zapret](https://github.com/bol-van/zapret) — bol-van, оригинальный проект
- Сообществу Windows-порта winws и движка winws2 (lua-desync)
- [WinDivert](https://github.com/basil00/WinDivert) — Graham Cleus

## Статус

**Pre-Release 0.2** — история изменений в [CHANGELOG.md](CHANGELOG.md). Багрепорты приветствуются — прикладывайте отчёт со страницы «Диагностика».
