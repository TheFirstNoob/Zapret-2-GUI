# Zapret 2 GUI — Аудит тестера (исторический, 2026-07-29, Pre-release 0.1)

> ⚠️ Исторический документ: фиксирует решённые проблемы ранних версий.
> Актуальная архитектура тестера — AGENTS.md (снапшот) + STRATEGY_TRIALS.
> Ниже — «решённые проблемы» как хроника; «Текущее состояние» устарело.
...
## Текущее состояние (устарело — актуально в AGENTS-снапшоте)
...
- Тестирование профилей (polling /api/tester/status, не WebSocket!)
- ZIP-отчёты с системной информацией
- CDN-хосты проверка
- Установка/удаление службы Windows
- Тогглы: GameFilter, Discord Voice, DEBUG, Auto Hostlist, ipset_catchall
