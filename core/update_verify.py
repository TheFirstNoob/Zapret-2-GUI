...
# ВНИМАНИЕ: сюда нельзя вставлять ключи из RFC/тестов — они публичны, и
# подписать ими обновление сможет любой (см. трипваер в тестах).
PUBKEY = "f6a4a021c8902f5000e4c6270acc57cd6e92d2703246bd3527f3b47e9b88872e"
